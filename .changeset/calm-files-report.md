...
bytes on the preceding main commit to 23,569 bytes. Raise its deterministic size ceiling from 23,000 to
24,500 bytes, retaining 3.9% headroom while continuing to reject larger unreviewed growth.
